...
class Hormiga:
    def __init__(self, canvas, cell_size, stats_frame):
        ...
        # Stats frame for visual indicators
        self.stats_frame = stats_frame
        self.setup_stat_displays()

    def setup_stat_displays(self):
        # Health display
        self.health_label = tk.Label(self.stats_frame, text="Health:", font=("Arial", 10))
        ...
        # Points display
        self.points_label = tk.Label(self.stats_frame, text="Points:", font=("Arial", 10))
    ...
    def update_stats_display(self):
        # Update health bar
        health_width = (self.health / 100) * 150  # Changed from 200 to 150
        self.health_canvas.coords(self.health_bar, 0, 0, health_width, 15)  # Height changed to 15
        ...
        # Update alcohol bar
        alcohol_width = (self.alcohol / 50) * 150  # Changed from 200 to 150
        self.alcohol_canvas.coords(self.alcohol_bar, 0, 0, alcohol_width, 15)  # Height changed to 15
    ...
    def create_ant(self, grid_x, grid_y):
        ...
        # Calculate triangle points for the ant
